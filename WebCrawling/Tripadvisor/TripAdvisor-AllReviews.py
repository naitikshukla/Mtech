...
####			Created by: Naitik Shukla		ON:8/12/2017		Version(1.0													                    	#####
#####################################################################################################################

#url=https://www.tripadvisor.com.sg/Attraction_Review-g294264-d2439664-Reviews-Universal_Studios_Singapore-Sentosa_Island.html#REVIEWS
#	 https://www.tripadvisor.com.sg/Attraction_Review-g294264-d2439664-Reviews-or10-Universal_Studios_Singapore-Sentosa_Island.html#REVIEWS
#Full review url : https://www.tripadvisor.com.sg/ShowUserReviews-g294264-d2439664-r511397830-Universal_Studios_Singapore-Sentosa_Island.html#REVIEWS
#				   https://www.tripadvisor.com.sg/ShowUserReviews-g294264-d2439664-r511153746-Universal_Studios_Singapore-Sentosa_Island.html#REVIEWS
import requests
...
def getReview(rev_link,id):
	...
	print("Now processing for review URL:",full_review_url)
...
f = open("trip-universal.txt","w+")
header = 'Name | Location | Date | Review Title | Ratings | UID | Review Text\n'
f.write(header)
